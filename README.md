...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-97%20passing-2ea44f" alt="Tests" />
  <img src="https://img.shields.io/badge/coverage-82%25-2ea44f" alt="Coverage" />
...
├── tests/                       # 97 pytest cases, 82% coverage
...
97 deterministic `pytest` cases, 82% overall coverage (95–100% on all non-UI logic):
